...
CGAffineTransform affineTransformLerp(CGAffineTransform from, CGAffineTransform to, float m) {
...
- (void)progress:(float)p target:(id)target imp:(IMP)imp selector:(SEL)sel {
    CGAffineTransform res = affineTransformLerp([self.fromValue CGAffineTransformValue],
                                                [self.toValue CGAffineTransformValue],
                                                p);
